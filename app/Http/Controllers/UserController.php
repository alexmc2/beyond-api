...
class UserController extends Controller
{
    ...
    private function getSharedData($user)
    {
        ...
        View::share('sharedData', ['currentlyFollowing' => $currentlyFollowing, 'avatar' => $user->avatar, 'name' => $user->name, 'postCount' => $user->posts()->count(), 'followerCount' => $user->followers()->count(), 'followingCount' => $user->followingTheseUsers()->count()]);
    }
    ...
    //         $user = User::where('name', $incomingFields['name'])->firstOrFail();
    //         $token = $user->createToken('ourapptoken')->plainTextToken;

    //         Log::info('Login successful', ['name' => $incomingFields['name']]);

    //         return response()->json(['token' => $token, 'user' => new UserResource($user)]);
    //     }

    //     Log::warning('Login failed', ['name' => $incomingFields['name']]);
